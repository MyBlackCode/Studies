using System;
using System.Collections.Generic; // umożliwia użytkownikom tworzenie silnie typicznych kolekcji
...
namespace CS_L4_NEW_
{
    internal class Program
    {
        ...
        {
            Student student1 = new Student("Jan", "Kowalski", new DateTime(1995, 1, 1), "Informatyka", 1, 1);
